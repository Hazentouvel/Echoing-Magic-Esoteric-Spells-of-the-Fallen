...
public class ReinforcedJuggernautArmorRenderer extends GeoArmorRenderer<ReinforcedJuggernautArmor> {
    public ReinforcedJuggernautArmorRenderer(ReinforcedJuggernautArmorModel reinforcedJuggernautArmorModel) {
        super(new ReinforcedJuggernautArmorModel());
        this.addRenderLayer(new ReinforcedJuggernautArmorLayer(this));
    ...
    public RenderType getRenderType(ReinforcedJuggernautArmor animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
