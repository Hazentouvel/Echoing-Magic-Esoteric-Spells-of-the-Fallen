...
public class EMSpellTooltip implements ClientTooltipComponent {

    public record EMSpellTooltipData(Component text) implements TooltipComponent {}

    private final Component text;
    private static final int AQUA = 0xc8fffe;
    private static final int BLUE = 0x00a5e7;

    public EMSpellTooltip(EMSpellTooltipData data) {
        this.text = data.text();
    }
