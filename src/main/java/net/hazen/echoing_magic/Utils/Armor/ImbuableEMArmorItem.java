...
public class ImbuableEMArmorItem extends EMArmorItem implements IPresetSpellContainer {
    public ImbuableEMArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties, AttributeContainer... attributeContainers) {
